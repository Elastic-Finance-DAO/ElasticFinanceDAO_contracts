...
module.exports = function(deployer, network, accounts) {
  deployer.then(async () => {
    ...
    await deployer.deploy(TokenGeyser,ampl.address,kmpl.address,2,20,14*24*60*60,1000000,ampl.address, {from : mainAccount});
    ...
    //Bucket A
    await kGeyser1.lockTokens(17793*1000000000, 90*24*60*60, 0, 0, {from : mainAccount});
    //Bucket B with 1% and 0.5% as rebase bonuses
    return await kGeyser1.lockTokens(5921*1000000000, 90*24*60*60, 10, 5, {from : mainAccount});
  })
};